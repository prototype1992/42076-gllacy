...
* Студент: [Сергей Шилкин](https://up.htmlacademy.ru/htmlcss/13/user/42076).
* Наставник: `Неизвестно`.


# Сергей, я твой наставник никак не могу с тобой связаться, получил твое задание на проверку, но ты забыл добавить меня в пункт настаника, сделать коммит и запушить (как было показано на вебинаре) после того как сделаешь я приму задание. напиши мне на почту (shoma.alisultanov@yandex.ru) или в скайп (termin05)
---
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/42076-gllacy) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
